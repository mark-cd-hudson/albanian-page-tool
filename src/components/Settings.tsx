  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
        <div className="bg-white dark:bg-gray-950 rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] flex flex-col">
          {/* Fixed Header */}
                  ...
                  {!showDeleteConfirm ? (
                    ...
                    <div className="bg-red-50 border border-red-300 rounded-lg p-4">
                      <p className="text-sm font-medium text-red-900 mb-3">
                        Are you sure? This will permanently delete all your
                        data, including pages, books, vocabulary, and review
